<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrList_thumb.aspx.cs" Inherits="Web.company.program.PrList_thumb" %>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(json.Table, function (idx, item) {
                        program_fullview_getSouceInfo(item.thumbnail,item.contenttype,windowsname);
                    });
                }
            });
        }
        function program_fullview_getSouceInfo(thumbnail, contenttype, windowname) {
           
            document.getElementById('Program_ArrangeMainFrame').contentWindow.document.getElementsByName(windowname)[0].src = "../program/thumbpreview.aspx?thumb="+thumbnail+"&ct="+contenttype+"&t=" + new Date().getTime();
        }
    </script>
</head>
<body>
